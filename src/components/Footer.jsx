...
const Footer = () => (
  <footer id="contact" className="py-20 border-t border-gray-100 dark:border-gray-800 transition-colors duration-300">
    <div className="max-w-4xl mx-auto px-4 text-center">
      <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Let's connect</h2>
      <p className="text-gray-600 dark:text-gray-400 mb-10 text-lg">
        Currently looking for new opportunities and interesting projects to contribute to.
      </p>
      ...
      <p className="mt-12 text-sm text-gray-400">
        © {new Date().getFullYear()} CleanPortfolio. All rights reserved.
      </p>
    </div>
  </footer>
);
